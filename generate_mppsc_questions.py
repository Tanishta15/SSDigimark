...
class MPPSCQuestionGenerator:
    ...
    def _load_question_templates(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            'madhya_pradesh_specific': [
                ...
                "Who was the prominent personality related to {} in Madhya Pradesh?",
                "What role did {} play in Madhya Pradesh's development?"
            ],
            'analytical': [
        ...
        for i in range(num_questions):
            ...
            if '{}' in template:
                if template.count('{}') == 1:
                    ...
                    # For factual_mcq templates, use the same topic twice
    ...
    def generate_ai_enhanced_questions(self, subject: str, num_questions: int = 5) -> List[Dict]:
        ...
        for i in range(num_questions):
            ...
            prompts = [
                f"Generate a multiple choice question about {topic} for MPPSC examination in Madhya Pradesh.",
                f"Create a question about {topic} relevant to Madhya Pradesh Public Service Commission exam.",
                f"Write a question on {topic} focusing on Madhya Pradesh context."
            ]
...
"""
        ...
        paper += "\n\n" + "="*50 + "\n"
        paper += "Answer Key: Contact your instructor\n"
